...
const dependencyTimer = startPerformanceTimer()
...
endPerformanceTimer('nunjucksLoader.js dependencies', dependencyTimer)
...
const NunjucksLoader = nunjucks.Loader.extend({
  init: function (appViews) {
    ...
    // TODO: Move this into the watcher thread
    if (this.noCache) {
  ...
  getSource: function (name) {
    console.log('get source callled', arguments, this)
    const timer = startPerformanceTimer()

...
function getConfig (config, swallowError = true) {
  ...
  overrideOrDefault('allowGovukFrontendUninstall', 'ALLOW_GOVUK_FRONTEND_UNINSTALL', asBoolean, true)

  // advanced
  overrideOrDefault('basePlugins', 'BASE_PLUGINS', asJson, ['govuk-prototype-kit', '@nowprototypeit/govuk', 'govuk-frontend'])
  ...
  // experiments
  overrideOrDefault('showPluginLookup', 'SHOW_PLUGIN_LOOKUP', asBoolean, false)

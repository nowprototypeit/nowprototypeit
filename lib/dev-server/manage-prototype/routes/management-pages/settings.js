const { managementLinks, getManagementView, contextPath } = require('../../utils')
...
function getSettingsView () {
  return getManagementView('settings.njk')
}
...
const setupSettingsRoutes = (router) => {
  setupUrlToHandleFields(router, '/settings', [
    ...
    },
    {
      ...
      description: 'BrowserSync automatically refreshes the browser when you make changes'
    }
  ])

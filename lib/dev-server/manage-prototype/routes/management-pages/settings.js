  ...
  setupUrlToHandleFields(router, '/settings', [
    {
      ...
      type: 'bool',
      name: 'Automatically store input data',
      description: 'Automatically capture data that users enter into your prototype and save it to their session when they submit a form, or when a parameter is in the query string.'
    },
    {
      key: 'showPrereleases',
      type: 'bool',
      name: 'Show plugin prereleases',
      description: 'Display pre-release versions of plugins on the Plugins page. By default, the Plugins page only displays the latest releases.'
    },
    {
      key: 'autoReloadPages',
      type: 'bool',
      name: 'Auto reload pages',
      description: 'Automatically refresh pages when you make changes to a file.'
    }
  ])
  setupUrlToHandleFields(router, '/settings/advanced', [
    {
      ...
      type: 'int',
      name: 'Network port',
      description: 'The network port that the kit runs on. By default this is set to 3000, which means you access your kit via http://localhost:3000/.'
    },
    {
      key: 'useAuth',
      type: 'bool',
      name: 'Use authentication',
      description: 'Password protect this prototype when it\'s hosted. We recommend this is always on.'
    },
    {
      key: 'useHttps',
      type: 'bool',
      name: 'Use HTTPS',
      description: 'Use HTTPS for your prototype. On hosted environments, HTTPS is important for the safety of any information passed from the user\'s browser to the prototype.'
    },
    {
      key: 'logPerformance',
      type: 'bool',
      name: 'Log performance',
      description: 'Log the time it takes for your system to run the internal processes of the prototype kit.'
    },
    {
      key: 'logPerformanceMatching',
      type: 'text',
      name: 'Log performance, matching',
      description: 'Limit performance logs to only include logs that contain the values in this field. Enter these as comma-seperated values.'
    },
    {
      key: 'logPerformanceSummary',
      type: 'int',
      name: 'Log performance summary',
      description: 'Log a performance summary on the schedule defined in this field. Enter the length of time (in milliseconds) you want between each performance report (e.g. 5000 for five seconds).'
    },
    {
      key: 'verbose',
      type: 'bool',
      name: 'Verbose logging',
      description: 'Log much more detailed performance information while the kit is running'
    },
    {
      key: 'passwordKeys',
      type: 'bool',
      name: 'Password Keys',
      description: 'A comma-separated list of environment variables to treat the same as PASSWORD. This allows you to set multiple passwords in multiple environment variables.'
    }
  ])
  setupUrlToHandleFields(router, '/settings/experiments', [
    {
      ...
      type: 'bool',
      name: 'Allow Markdown and HTML file extensions',
      stage: 1,
      description: 'Enable the use of Markdown (.md) and HTML (.html) files for creating pages. Pages containing Nunjucks code must still be in .njk files. Extremely experimental, implementation is very likely to change.'
    },
    {
      key: 'hostingEnabled',
      type: 'bool',
      name: 'Display the Sharing page in the Prototype Manager',
      stage: 1,
      description: 'Enable the Sharing page and allow access to NPI Cloud for sharing prototypes. This feature is currently in testing with our first round of users.'
    },
    {
      key: 'editInBrowser',
      type: 'bool',
      ...
      stage: 1,
      description: 'Edit your prototype in the browser, instead of (or as well as) your code editor, using an in-browser version of VSCode.'
    }
  ])

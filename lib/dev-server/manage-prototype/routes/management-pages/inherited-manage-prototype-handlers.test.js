...
const standardClearDataModel = {
  ...
  links: [
    ...
    },
    {
      ...
      url: '/manage-prototype/clear-data'
    }],
...
describe('manage-prototype-handlers', () => {
  ...
  it('getClearDataHandler', () => {
    ...
    expect(mockNunjucksRender).toHaveBeenCalledWith(
      'nowprototypeit/views/manage-prototype/clear-data.njk',
      standardClearDataModel
    )
  })
  ...
  it('postClearDataHandler', () => {
    ...
    expect(mockNunjucksRender).toHaveBeenCalledWith(
      'nowprototypeit/views/manage-prototype/clear-data-success.njk',
      standardClearDataModel
    )
  })
  ...
  it('getPasswordHandler', () => {
    ...
    expect(mockNunjucksRender).toHaveBeenCalledWith(
      'nowprototypeit/views/manage-prototype/password.njk',
  ...
  it('getHomeHandler', async () => {
    ...
    expect(mockNunjucksRender).toHaveBeenCalledWith(
      'nowprototypeit/views/manage-prototype/index.njk',
      expect.objectContaining({
        currentSection: 'Home',
  ...
  describe('developmentOnlyMiddleware', () => {
    it('in production', () => {
      ...
      expect(mockNunjucksRender).toHaveBeenCalledWith(
        'nowprototypeit/views/manage-prototype/manage-prototype-not-available.njk',
        req.app.locals
      )
    })
  ...
  describe('templates handlers', () => {
    ...
    it('getTemplatesHandler', async () => {
      ...
      expect(mockNunjucksRender).toHaveBeenCalledWith(
        'nowprototypeit/views/manage-prototype/templates.njk',
        expect.objectContaining({
          ...req.app.locals,
    ...
    describe('getTemplatesInstallHandler', () => {
      describe('template found', () => {
        ...
        async function testGetTemplatesInstallHandler (error) {
          ...
          expect(res.status).not.toHaveBeenCalled()
          expect(mockNunjucksRender).toHaveBeenCalledWith(
            'nowprototypeit/views/manage-prototype/template-install.njk',
            expect.objectContaining({
              ...req.app.locals,
              currentSection: 'Templates',
    ...
    it('getTemplatesPostInstallHandler', async () => {
      ...
      expect(mockNunjucksRender).toHaveBeenCalledWith(
        'nowprototypeit/views/manage-prototype/template-post-install.njk',
        expect.objectContaining({
          ...req.app.locals,
          currentSection: 'Templates',

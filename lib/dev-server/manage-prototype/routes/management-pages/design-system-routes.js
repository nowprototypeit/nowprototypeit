...
if (global.runningOnServerWatchNotNeeded) {
  module.exports = {
    setupDesignSystemRoutes: () => {}
  }
  global.logTimeFromStart('design system routes not needed')
} else {
  ...
  global.logTimeFromStart('design system routes added')
}

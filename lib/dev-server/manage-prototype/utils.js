...
function warmUpEditInBrowserMarkup () {
  editInBrowserMarkupPromise = Promise.all([
    ...
    .then(([html, js]) => `<link rel="stylesheet" href="/manage-prototype/assets/edit-in-browser/main-include.css">${html}<script>${js}</script><script src="/manage-prototype/assets/edit-in-browser/main-include.js"></script>`)
}

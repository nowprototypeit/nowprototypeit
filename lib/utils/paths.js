...
exports.appViewsDir = path.join(exports.appDir, 'views')
...
exports.backupNunjucksDir = path.join(exports.tmpDir, 'backup-nunjucks')
exports.commandsDir = path.join(exports.tmpDir, 'commands')

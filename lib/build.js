...
function sassVariables (contextPath = '', isLegacyGovukFrontend = false) {
  ...
  fileContents += `$nowprototypeit-plugins-url-context: "${contextPath}";\n`
  fileContents += '$nowprototypeit-major-version: 0;\n'

...
function showNoPasswordError (res) {
  ...
  return res.send(`<h1>Error:</h1><p>Password not set. <a href="https://docs.nowprototype.it/${encodeURIComponent(kitVersion)}/self-hosting/password-requirements">See guidance for setting a password</a>.</p>`)
}
